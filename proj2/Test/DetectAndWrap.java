...
public class DetectAndWrap extends Application {
    ...
    private class KeyEventHandler implements EventHandler<KeyEvent> {
        ...
        ArrayList<Text> displayTextList = new ArrayList<>();
        Group myroot;
        ...
        public void handle(KeyEvent keyEvent) {
            if (keyEvent.getEventType() == KeyEvent.KEY_TYPED) {
                ...
                if (characterTyped.charAt(0) == '\r') {
                    textCenterY += new Text(5, 5, "\r").getLayoutBounds().getHeight();
                    textCenterX = 5;
                }
                    ...
                    displayText = new Text(textCenterX, textCenterY, characterTyped);
                    displayText.setTextOrigin(VPos.TOP);
                    displayText.setFont(Font.font(fontName, fontSize));

                    myroot.getChildren().add(displayText);
                    textCenterX += 20;
                    System.out.println(textCenterX);
